...
function incoming_deceased_validateData(){
	...
	/* Field tag_number can't be empty */
	if($j('#tag_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tag number", close: function(){ /* */ $j('[name=tag_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field serial_number can't be empty */
	if($j('#serial_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Serial number", close: function(){ /* */ $j('[name=serial_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field room can't be empty */
	if($j('#room').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Room", close: function(){ /* */ $j('[name=room]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field bed can't be empty */
	if($j('#bed').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Bed", close: function(){ /* */ $j('[name=bed]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function outgoing_deceased_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field fullname can't be empty */
	if($j('#fullname').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Fullname", close: function(){ /* */ $j('[name=fullname]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function relatives_info_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field first_relative_full_name can't be empty */
	if($j('#first_relative_full_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> First relative full name", close: function(){ /* */ $j('[name=first_relative_full_name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field home_address can't be empty */
	if($j('#home_address').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Home address", close: function(){ /* */ $j('[name=home_address]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field home_town can't be empty */
	if($j('#home_town').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Home town", close: function(){ /* */ $j('[name=home_town]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field occupation can't be empty */
	if($j('#occupation').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Occupation", close: function(){ /* */ $j('[name=occupation]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field phone_number can't be empty */
	if($j('#phone_number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Phone number", close: function(){ /* */ $j('[name=phone_number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function rooms_validateData(){
	$j('.has-error').removeClass('has-error');
...
function services_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field name can't be empty */
	if($j('#name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Name", close: function(){ /* */ $j('[name=name]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field type can't be empty */
...
function beds_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field number can't be empty */
	if($j('#number').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Number", close: function(){ /* */ $j('[name=number]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field room can't be empty */
	if($j('#room').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Room", close: function(){ /* */ $j('[name=room]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field status can't be empty */
	if($j('#status').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Status", close: function(){ /* */ $j('[name=status]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
...
function bill_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field deceased can't be empty */
	if($j('#deceased').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Deceased", close: function(){ /* */ $j('[name=deceased]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field paid_amount can't be empty */
	if($j('#paid_amount').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Paid amount", close: function(){ /* */ $j('[name=paid_amount]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	return true;
}
function invoices_validateData(){
	...
	/* Field deceased can't be empty */
	if($j('#deceased').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Deceased", close: function(){ /* */ $j('[name=deceased]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
	/* Field services can't be empty */
	if($j('#services').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Services", close: function(){ /* */ $j('[name=services]').focus().parents('.form-group').addClass('has-error'); } }); return false; };
...
function persist_expanded_child(id){
	var expand_these = Cookies.getJSON('Morgue_Management.dvp_expand');
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			Cookies.set('Morgue_Management.dvp_expand', expand_these, { expires: 30 });
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
