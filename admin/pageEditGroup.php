...
<form method="post" action="pageEditGroup.php" class="form-horizontal">
	...
	<div class="table-responsive">
		<table class="table table-striped table-bordered table-hover">
			<caption>
				<h2><?php echo $Translation["group table permissions"]; ?></h2>
			</caption>
			<thead>
				<tr>
					<th>
						<div><?php echo $Translation["table"]; ?></div>
					</th>
					<th>
						<div><?php echo $Translation["insert"]; ?></div>
					</th>
					<th>
						<div><?php echo $Translation["view"]; ?></div>
					</th>
					<th>
						<div><?php echo $Translation["edit"]; ?></div>
					</th>
					<th>
						<div><?php echo $Translation["delete"]; ?></div>
					</th>
				</tr>
			</thead>
			<tbody>
