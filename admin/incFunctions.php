...
function get_tables_info($skip_authentication = false)
{
	...
	$all_tables = array(
		...
		'outgoing_deceased' => array(
			'Caption' => 'Outgoing deceased',
			'Description' => '',
			'tableIcon' => 'resources/table_icons/application_side_contract.png',
			'group' => $tg[0],
			'homepageShowCount' => 0
		),
		'relatives_info' => array(
			'Caption' => 'Relatives info',
			'Description' => '',
		...
		'beds' => array(
			'Caption' => 'Beds',
			'Description' => '',
			'tableIcon' => 'resources/table_icons/tag_green.png',
			'group' => $tg[0],
			'homepageShowCount' => 0
		),
		'bill' => array(
...
if (!function_exists('getTableList')) {
	...
	{
		$arrTables = array(
			'incoming_deceased' => 'Incoming deceased',
			'outgoing_deceased' => 'Outgoing deceased',
			'relatives_info' => 'Relatives info',
			'rooms' => 'Rooms',
			'beds' => 'Beds',
			'bill' => 'Bill',
			'invoices' => 'Invoices',
