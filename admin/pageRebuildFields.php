	...
	*/
	...
	$schema = array(   
		'incoming_deceased' => array(   
			...
			'fullname' => array('appgini' => 'VARCHAR(150) not null '),
			'gender' => array('appgini' => 'VARCHAR(40) not null '),
			'tag_number' => array('appgini' => 'VARCHAR(40) not null '),
			'serial_number' => array('appgini' => 'VARCHAR(40) not null '),
			'relative_name' => array('appgini' => 'INT unsigned '),
			'relative_number' => array('appgini' => 'INT unsigned '),
			'room' => array('appgini' => 'INT unsigned not null '),
			'bed' => array('appgini' => 'INT unsigned not null '),
			'date' => array('appgini' => 'DATE ')
		),
		'outgoing_deceased' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'fullname' => array('appgini' => 'INT unsigned not null '),
			'gender' => array('appgini' => 'INT unsigned '),
			'tag_number' => array('appgini' => 'INT unsigned '),
			'serial_number' => array('appgini' => 'INT unsigned '),
			'relative_name' => array('appgini' => 'INT unsigned '),
			'relative_phone_number' => array('appgini' => 'INT unsigned '),
			'date' => array('appgini' => 'DATE '),
			'car_out_number' => array('appgini' => 'VARCHAR(40) ')
		),
		'relatives_info' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'first_relative_full_name' => array('appgini' => 'VARCHAR(150) not null '),
			'home_address' => array('appgini' => 'VARCHAR(200) not null '),
			'home_town' => array('appgini' => 'VARCHAR(200) not null '),
			'occupation' => array('appgini' => 'VARCHAR(100) not null '),
			'phone_number' => array('appgini' => 'VARCHAR(40) not null '),
			'second_relative_full_name' => array('appgini' => 'VARCHAR(40) '),
			'second_relative_home_address' => array('appgini' => 'VARCHAR(40) '),
			'second_relative_home_town' => array('appgini' => 'VARCHAR(40) '),
			'second_relative_occupation' => array('appgini' => 'VARCHAR(40) '),
			'second_relative_phone_number' => array('appgini' => 'VARCHAR(40) ')
		),
		'rooms' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
		...
		'beds' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'number' => array('appgini' => 'VARCHAR(40) not null '),
			'room' => array('appgini' => 'INT unsigned not null '),
			'status' => array('appgini' => 'VARCHAR(40) not null ')
		),
		'bill' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'deceased' => array('appgini' => 'INT unsigned not null '),
			'total' => array('appgini' => 'INT unsigned '),
			'paid_amount' => array('appgini' => 'INT not null '),
			'balance' => array('appgini' => 'INT unsigned ')
		),
		'invoices' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'deceased' => array('appgini' => 'INT unsigned not null '),
			'room' => array('appgini' => 'INT unsigned '),
			'relative' => array('appgini' => 'INT unsigned '),
			'services' => array('appgini' => 'TEXT not null '),
			'total' => array('appgini' => 'INT not null '),
